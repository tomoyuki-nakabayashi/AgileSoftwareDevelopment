...
#ifndef SALARYSYSTEM_TRANSACTION_ADD_COMMISSIONED_EMPLOYEE_H_
#define SALARYSYSTEM_TRANSACTION_ADD_COMMISSIONED_EMPLOYEE_H_
...
#endif  // SALARYSYSTEM_TRANSACTION_ADD_COMMISSIONED_EMPLOYEE_H_
